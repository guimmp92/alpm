...
static gboolean
pk_backend_transaction_remove_targets (PkBackend *self, GError **error, gchar **package_ids)
{
	gchar **packages;
        guint i;
        guint lpackages;
...
static gboolean
pk_backend_simulate_remove_packages_thread (PkBackend *self, PkBackendJob *job, gchar **package_ids)
{
	...
	if (pk_backend_transaction_initialize (self, flags, &error) &&
	    pk_backend_transaction_remove_targets (self, &error, package_ids) &&
...
static gboolean
pk_backend_remove_packages_thread (PkBackend *self, PkBackendJob *job, gchar **package_ids)
{
...
void
pk_backend_simulate_remove_packages (PkBackend *self, PkBackendJob *job, PkBitfield transaction_flags, gchar **package_ids, gboolean allow_deps, gboolean autoremove)
{
...
void
pk_backend_remove_packages (PkBackend *self, PkBackendJob *job, PkBitfield transaction_flags,gchar **package_ids,
